...
/***
 *     ,ggg,        gg                                    ,gggggggggggggg                         
 *    dP""Y8b       88                        ,dPYb,     dP""""""88""""""                         
 *    Yb, `88       88                        IP'`Yb     Yb,_    88                               
 *     `"  88       88                        I8  8I      `""    88                               
 *         88aaaaaaa88                        I8  8'          ggg88gggg                           
 *         88"""""""88    ,gggg,gg    ,g,     I8 dPgg,           88   8,gggggg,   ,ggg,    ,ggg,  
 *         88       88   dP"  "Y8I   ,8'8,    I8dP" "8I          88    dP""""8I  i8" "8i  i8" "8i 
 *         88       88  i8'    ,8I  ,8'  Yb   I8P    I8    gg,   88   ,8'    8I  I8, ,8I  I8, ,8I 
 *         88       Y8,,d8,   ,d8b,,8'_   8) ,d8     I8,    "Yb,,8P  ,dP     Y8, `YbadP'  `YbadP' 
 *         88       `Y8P"Y8888P"`Y8P' "YY8P8P88P     `Y8      "Y8P'  8P      `Y8888P"Y888888P"Y888
 *                                                                                                
 *                                                                                                
 *                                                                                                
 *                                                                                                
...
contract HashFree is ERC20Detailed, Ownable {
    ...
    event ReferralRecord(address sender, address[] referrals,  uint256[] partsFee);
    ...
    function takeFee(
        ...
        if (sender == pair) {
            ...
            (uint8 count, address[] memory _referrals) = IHashFreeDao(
                hashDaoAddress
            ).getRelations(recipient);
            if (count > 0) {
                uint256[] memory referralFee = new uint256[](count);
                for (uint8 i = 0; i < count; i++) {
                    ...
                    _gonBalances[_referrals[i]] = _gonBalances[_referrals[i]].add(
                        _parentFee
                    );
                    uint256 partFee = _parentFee.div(_gonsPerFragment);
                    referralFee[i] = partFee;
                    emit Transfer(
                        recipient,
                        _referrals[i],
                        partFee
